<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.entities.Pet,java.util.Date,java.io.File,java.nio.file.Files,java.util.Base64"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- head-nav -->
	...
	String coatColor = pet.getCoatColor();
	String age = pet.getAge();
	String location = pet.getLocation();
	String species = pet.getSpecies();
	String size = pet.getSize();
	String quest = pet.getQuest();
	String photo = pet.getPhotos();
				...
				<form action="update-pet" method="POST"
					...
					<div class="grid form-grid">
						...
						<div class="form-flex">
							...
							<input
								type="text" class="input-text" id="petName" name="petName"
								placeholder="貓貓貓" value="<%=petName%>" />
						</div>

						<div class="form-flex">
							<label for="breed" class="pet__form-lab">品種</label> 
							<input
								type="text" class="input-text" id="breed" name="breed"
								placeholder="金吉拉" value="<%=breed%>" />
						</div>

						<div class="form-flex">
							<label for="gender" class="pet__form-lab">性別</label> 
							<input
								type="text" class="input-text" id="gender" name="gender"
								placeholder="性別" value="<%=gender%>" />
						</div>

						<div class="form-flex">
							<label for="coatColor" class="pet__form-lab">毛色</label> 
							<input
								type="text" class="input-text" id="coatColor"
								name="coatColor" placeholder="毛色" value="<%=coatColor%>" />
						</div>

						<div class="form-flex">
							<label for="age" class="pet__form-lab">年齡</label> 
							<input type="text"
								class="input-text" id="age" name="age" placeholder="1"
								value="<%=age%>" />
						</div>
						...
						<div class="form-flex">
							...
							<input
								type="text" class="input-text" id="location"
								name="location" placeholder="桃園" value="<%=location%>" />
						</div>

						<div class="form-flex">
							<label for="species" class="pet__form-lab">種類</label> 
							<input
								type="text" class="input-text" id="species" name="species"
								placeholder="種類" value="<%=species%>" />
						</div>

						<div class="form-flex">
							<label for="size" class="pet__form-lab">體型</label> <input
								type="text" class="input-text" id="size" name="size"
								placeholder="體型" value="<%=size%>" />
						</div>
